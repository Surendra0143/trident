		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#rdminspzqmrdminsp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rdminspzqmrdminsp1-display": {
								"semanticObject": "rdminspzqmrdminsp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rdm.insp.zqmrdminsp1",
									"url": sap.ui.require.toUrl("rdm/insp/zqmrdminsp1")
								}
							}
						}
					}
