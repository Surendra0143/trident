...
sap.ui.define([
	...
	var oListReportExtController = {
		...
		_getSelectFormDialog: function () {
			if (this._oSelectFormDialog === undefined) {
				...
				this._oSelectFormDialog = sap.ui.xmlfragment("ehszqmrep.CreateSummaryReportDialog", this);
	...
	sap.ui.controller("ehszqmrep.ListReportExt", oListReportExtController);
	return Controller.extend("ehszqmrep.ListReportExt", oListReportExtController);
});