...
sap.ui.define([
    ...
    var oObjectPageExtClass = {
        ...
        onInit: function () {
            ...
            if (!sap.ui.Device.system.phone) {
                var sLocationUUIDFieldId =
                    "ehszqmrep::sap.suite.ui.generic.template.ObjectPage.view.Details::C_SummaryReportRootTP--ReportCriteriaFieldsReportNode::EHSLocationUUID::Field";
        ...
        _callGenerateSummaryReportFunctionImport: function (oBindingContext) {
            var oDateFromField = this.byId(
                "ehszqmrep::sap.suite.ui.generic.template.ObjectPage.view.Details::C_SummaryReportRootTP--ReportCriteriaFieldsReportNode::EHSReportFromDate::Field"
            );
        ...
        updateLocationInputValue: function (sNewKey) {
            var oLocationInput = this._oView.byId(
                "ehszqmrep::sap.suite.ui.generic.template.ObjectPage.view.Details::C_SummaryReportRootTP--ReportCriteriaFieldsReportNode::EHSLocationUUID::Field-input"
            );
    ...
    sap.ui.controller("ehszqmrep.ObjectPageExt", oObjectPageExtClass);
    return Controller.extend("ehszqmrep.ObjectPageExt", oObjectPageExtClass);
});