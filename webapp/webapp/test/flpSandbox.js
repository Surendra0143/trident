		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zpp_weste_book",
									"targetURL": "#comtridentwesteproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtridentwesteproject1-display": {
								"semanticObject": "comtridentwesteproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.trident.weste.project1",
									"url": sap.ui.require.toUrl("com/trident/weste/project1")
								}
							}
						}
					}
