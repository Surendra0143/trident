		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rework Confirmation Punching",
									"targetURL": "#comsaprcpzqmreworkconfirm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaprcpzqmreworkconfirm-display": {
								"semanticObject": "comsaprcpzqmreworkconfirm",
								"action": "display",
								"description": "Rework Confirmation Punching",
								"title": "Rework Confirmation Punching",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.rcp.zqmreworkconfirm",
									"url": sap.ui.require.toUrl("com/sap/rcp/zqmreworkconfirm")
								}
							}
						}
					}
