		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Random Inspect",
									"targetURL": "#comsaprdminspectzqmrdminspect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaprdminspectzqmrdminspect-display": {
								"semanticObject": "comsaprdminspectzqmrdminspect",
								"action": "display",
								"description": "Random Ispect",
								"title": "Random Inspect",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.rdminspect.zqmrdminspect",
									"url": sap.ui.require.toUrl("com/sap/rdminspect/zqmrdminspect")
								}
							}
						}
					}
