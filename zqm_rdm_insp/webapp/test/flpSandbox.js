		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsaprizqmrdminsp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaprizqmrdminsp-display": {
								"semanticObject": "comsaprizqmrdminsp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ri.zqmrdminsp",
									"url": sap.ui.require.toUrl("com/sap/ri/zqmrdminsp")
								}
							}
						}
					}
