		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapfirstpiecezqmfirstpiece-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapfirstpiecezqmfirstpiece-display": {
								"semanticObject": "comsapfirstpiecezqmfirstpiece",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.firstpiece.zqmfirstpiece",
									"url": sap.ui.require.toUrl("com/sap/firstpiece/zqmfirstpiece")
								}
							}
						}
					}
